...
public class Wheels extends CarPart{
	...
	//constructor
	public Wheels(float inflationPSI) {
		super("wheel", "% traction", 100);
		instanceCount += 1;
	...
	public void status() {
		System.out.println("Tire #" + this.tireNumber + " (serial #00" + this.serialNumber + ") is at " + this.condition + this.conditionMeasure + " and " + this.inflationPSI + "psi.");
	}
	public void status(String extraMessage) {
		System.out.print("Tire #" + this.tireNumber +  " (" + this.condition + this.conditionMeasure + ", " + this.inflationPSI + "psi) says: ");
